...
export default defineRailway(() => {
  ...
  const videoServer = service("video-server", {
    ...
    env: {
      NODE_ENV: "production",
      S3_ENDPOINT:"https://dc63d7e1f34a4437a67e242e912fda34.r2.cloudflarestorage.com",
      S3_ACCESS_KEY_ID: "50929696d185dd613c0d3a94daeeac7a",
      S3_SECRET_ACCESS_KEY: "00c3524b928e0270fbd3fea11b30285a5f1c3a9162f06966258209fba9c4d451",
